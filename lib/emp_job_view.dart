...
class _JobDetailsScreenState extends State<JobDetailsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.job['Job Title']),
      ),
      body: Center(
        child: Column(
              ...
              child: Stack(
                children: [
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      '${widget.job['Salary']} ${widget.job['Salary Frequency']}',
                                      style: TextStyle(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${widget.job['job_city']}, ${widget.job['job_state']}',
                                      style: TextStyle(
                                          color: Color(0xFF0098DA),
                                          fontSize: 16,
                  ...
                  Positioned(
                    top: 10,
                    right: 10,
                    child: Text("${widget.job['Vacancy Left']} Vacancy Left"),
                  ),
                ],
              ),
            ),
