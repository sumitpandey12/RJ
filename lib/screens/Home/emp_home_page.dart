...
import 'package:rotijugaad/screens/JobPosts/emp_job.dart';
import 'package:rotijugaad/emp_lang_update.dart';
import 'package:rotijugaad/models/jobModel.dart';
import 'package:rotijugaad/screens/Login/login_screen.dart';
import 'package:rotijugaad/screens/Personal%20Info/emp_personal_info.dart';
import 'package:rotijugaad/screens/Personal%20Info/emp_profile_page.dart';
import 'package:rotijugaad/screens/Subscription/emp_subscription.dart';
import 'package:rotijugaad/screens/HiringHistory/hiring_history.dart';
import 'package:rotijugaad/payment_history.dart';
import 'package:rotijugaad/support.dart';
import 'package:rotijugaad/user_notif.dart';
import 'package:rotijugaad/utils/utils.dart';
import 'package:rotijugaad/screens/UserProfile/view_user_profile.dart';
...
class _EmployerHomePageState extends State<EmployerHomePage> {
  ...
  List<EmployeeModel>? listOfEmployee;
  bool isLoading = true;
  ...
  fetchAvilableCandidate() async {
    isLoading = true;
    listOfEmployee = await EmployerService.getAvailableCandidates(
        frequency: selectedIndex != 0 ? "Day" : "Month");
    log("Length : ${listOfEmployee?.length.toString()}");
    setState(() {
      isLoading = false;
    });
  }
  ...
  fetchData() async {
    ...
    if (employer != null) {
      SharedPreferences pref = await SharedPreferences.getInstance();
      pref.setInt("EmployerID", employer!.employerID!);
      pref.setString("Name", employer!.name!);
      name = employer?.name;
      orgnizationName = employer?.organization;
    } else {
      log("Employer == null");
    }
    fetchAvilableCandidate();
    ...
    var dropdownButton = DropdownButton<String>(
        ...
        items: [
          DropdownMenuItem(
            ...
            child:
                Text(_isEnglishSelected ? 'Security Guard' : 'सुरक्षा कर्मी'),
          ),
          DropdownMenuItem(
            value: 'Helper',
          ...
          DropdownMenuItem(
            ...
            child:
                Text(_isEnglishSelected ? 'Vehicle Mechanic' : 'कार मिस्त्री'),
          ),
          DropdownMenuItem(
            value: 'Makeup Artist',
            child:
                Text(_isEnglishSelected ? 'Makeup Artist' : 'मेक-अप अर्टिस्ट'),
          ),
          DropdownMenuItem(
            value: 'Hair Stylish',
          ...
          DropdownMenuItem(
            ...
            child: Text(
                _isEnglishSelected ? 'Beauty Salon Staff' : 'ब्यूटी पार्लर'),
          ),
          DropdownMenuItem(
            value: 'Factory Staff',
          ...
          DropdownMenuItem(
            ...
            child: Text(
                _isEnglishSelected ? 'Gym/ Yoga Trainer' : 'जिम/योग ट्रेनर'),
          ),
          DropdownMenuItem(
            value: 'Hotel Staff',
          ...
          DropdownMenuItem(
            ...
            child: Text(
                _isEnglishSelected ? 'Restaurant Staff' : 'रेस्टोरेंट स्टाफ'),
          ),
          DropdownMenuItem(
          ...
          DropdownMenuItem(
            value: 'LED/TV Repair',
            child: Text(
                _isEnglishSelected ? 'LED/TV Repair' : 'एलईडी टीवी मिस्त्री'),
          ),
          DropdownMenuItem(
            value: 'Car Detailing Staff',
            child: Text(
                _isEnglishSelected ? 'Car Detailing Staff' : 'डिटेलिंग स्टाफ'),
          ),
          DropdownMenuItem(
            value: 'Car/Auto  Denter',
            child: Text(
                _isEnglishSelected ? 'Car/Auto  Denter' : 'कार / ऑटो डेंटर'),
          ),
          DropdownMenuItem(
            value: 'Car Painter',
          ...
          DropdownMenuItem(
            value: 'Mehndi Artist',
            child:
                Text(_isEnglishSelected ? 'Mehndi Artist' : 'मेहँदी अर्टिस्ट'),
          ),
          DropdownMenuItem(
            value: 'Others',
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: GestureDetector(
          onTap: () {
            complete_profile_prompt(context);
          },
          child: Row(
            children: [
              Expanded(
              ...
              Container(
                  ...
                  child: (employer == null)
                      ...
                      : (employer?.profileCompleted == null ||
                              employer?.profileCompleted! == false)
                          ? const Icon(
                              Icons.warning,
                              color: Colors.yellow,
                            )
                ...
                children: [
                  Column(
                    children: [
                      ...
                      GestureDetector(
                        child: Text(
                          orgnizationName ?? 'Organisation Name',
                          style: TextStyle(
                        ...
                        onTap: () {
                          if (employer != null) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => EmpProfilePage(),
                              ),
                            );
                          } else {
                            complete_profile_prompt(context);
                      ...
                      GestureDetector(
                        child: Text(
                          _isEnglishSelected ? 'Job Posts' : 'नियुक्तियां',
                          style: TextStyle(
                              fontSize: 20, fontWeight: FontWeight.w400),
                        ),
                        onTap: () {
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => HiringHistoryPage(),
                            ),
                          );
                        },
                      ),
                      ...
                      GestureDetector(
                        child: Text(
                          _isEnglishSelected ? 'Language' : 'भाषा',
                          style: TextStyle(
                              fontSize: 20, fontWeight: FontWeight.w400),
                        ),
                        onTap: () {
                      ...
                      GestureDetector(
                        child: Text(
                          _isEnglishSelected ? 'Log Out' : 'लॉग आउट',
                          style: TextStyle(
                              fontSize: 20, fontWeight: FontWeight.w400),
                        ),
                        onTap: () async {
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => EmpSubscription(
                                employer: employer,
                              ),
                            ),
                          );
          ...
          children: [
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: _isFirstButtonSelected ? null : _selectFirstButton,
                      child: Container(
                        decoration: BoxDecoration(
                          border: Border.all(
                            color: Colors.blue,
                        ...
                        child: Text(
                          _isEnglishSelected ? "Monthly Salary" : "मासिक वेतन",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap:
                          _isFirstButtonSelected ? _selectSecondButton : null,
                      child: Container(
                        decoration: BoxDecoration(
                          border: Border.all(
                            color: Colors.blue,
                        ...
                        child: Text(
                          _isEnglishSelected ? "Daily Salary" : "दैनिक वेतन",
                          textAlign: TextAlign.center,
                          style: TextStyle(
            ...
            Expanded(
                child: isLoading
                    ...
                    : (listOfEmployee == null || listOfEmployee?.length == 0)
                        ? Center(
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding:
                                                        const EdgeInsets.only(
                                                            left: 8.0),
                                                    child: Text(
                                                      "${listOfEmployee![index].jobPreference}",
                                                      style: TextStyle(
                                                          color:
                                                              Color(0xFF0098DA),
                                                          fontSize: 22,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      padding:
                                                          EdgeInsets.symmetric(
                                                              ...
                                                              vertical: 5),
                                                      child: Text(
                                                        '${listOfEmployee![index].expectedSalary} ${listOfEmployee![index].salaryFrequency}',
                                                        style: TextStyle(
                                                            color: Colors.white,
                                                            fontSize: 16),
                                                      ),
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: Text(
                                                          '${listOfEmployee![index].preferredCity}, ${listOfEmployee![index].preferredStateUt}',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          if (employer == null || employer?.approved == false) {
            complete_profile_prompt(context);
            return;
          }
          if (employer!.jobPostCredits! < 1) {}

          String? _jobProfile;
          String? _selectedVacancy;
          String? _salaryOffered;
          String? _frequency;

          final List<String> _vacancyOptions = [
            '1',
            '2',
            '3',
            '4',
                ...
                content: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      DropdownButtonFormField<String>(
                        ...
                        items: [
                          ...
                          DropdownMenuItem(
                            value: 'Helper',
                            child:
                                Text(_isEnglishSelected ? 'Helper' : 'सहायक'),
                          ),
                          DropdownMenuItem(
                            value: 'Salesman',
                            child: Text(
                                _isEnglishSelected ? 'Salesman' : 'विक्रेता'),
                          ),
                          DropdownMenuItem(
                            value: 'Delivery Boy',
                            child: Text(_isEnglishSelected
                          ...
                          DropdownMenuItem(
                            value: 'Manager',
                            child: Text(
                                _isEnglishSelected ? 'Manager' : 'प्रबंधक'),
                          ),
                          DropdownMenuItem(
                            value: 'Cleaning Expert',
                            child: Text(_isEnglishSelected
                          ...
                          DropdownMenuItem(
                            value: 'Accountant',
                            child: Text(
                                _isEnglishSelected ? 'Accountant' : 'मुनीम'),
                          ),
                          DropdownMenuItem(
                            value: 'Cook',
                            child: Text(_isEnglishSelected ? 'Cook' : 'रसोइया'),
                          ...
                          DropdownMenuItem(
                            value: 'Carpenter',
                            child:
                                Text(_isEnglishSelected ? 'Carpenter' : 'बढ़ई'),
                          ),
                          DropdownMenuItem(
                            value: 'Dry Cleaning Staff',
                            child: Text(_isEnglishSelected
                          ...
                          DropdownMenuItem(
                            value: 'Painter',
                            child:
                                Text(_isEnglishSelected ? 'Painter' : 'पेंटर'),
                          ),
                          DropdownMenuItem(
                            value: 'Photographer',
                            child: Text(_isEnglishSelected
                          ...
                          DropdownMenuItem(
                            value: 'Plumber',
                            child:
                                Text(_isEnglishSelected ? 'Plumber' : 'पलंबर'),
                          ),
                          DropdownMenuItem(
                            value: 'Tailor',
                            child:
                                Text(_isEnglishSelected ? 'Tailor' : 'दर्जी'),
                          ),
                          DropdownMenuItem(
                            value: 'Teacher',
                            child:
                                Text(_isEnglishSelected ? 'Teacher' : 'शिक्षक'),
                          ),
                          DropdownMenuItem(
                            value: 'Electrician',
                            child: Text(_isEnglishSelected
                      ...
                      DropdownButtonFormField<String>(
                        decoration: InputDecoration(
                          labelText: _isEnglishSelected ? "Vacancy" : "Vacancy",
                          border: const UnderlineInputBorder(),
                          labelStyle: const TextStyle(
                            color: Color(0xFF0098DA),
                          ),
                        ...
                        items: _vacancyOptions.map((vacancy) {
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          if (_jobProfile == null ||
                              ...
                              _salaryOffered == null ||
                              _frequency == null) {
                            log("Select All Options");
                            log("${_jobProfile}, ${_selectedVacancy}, ${_salaryOffered}, ${_frequency}");
                          } else if (employer != null) {
                            JobModel? response = await EmployerService.postJobs(
                                _jobProfile!,
                                _selectedVacancy!,
                                _salaryOffered!,
                                _frequency!,
  ...
  Future<dynamic> complete_profile_prompt(BuildContext context) {
    if (employer != null &&
                ...
                children: [
                  Center(
                    child: Text(
                      _isEnglishSelected
                          ? (employer == null)
                              ? "Your profile is not complited!"
                              : (employer?.profileCompleted! == false)
                                  ? "your profile is partially complited"
                                  : (employer?.approved == false)
                                      ? "You will be notified once approved"
                                      : "Welcome, your are now approved"
                          : 'आपकी प्रोफ़ाइल पूरी नहीं हुई है।',
                          ...
                          ? (employer == null)
                              ...
                              : (employer?.profileCompleted! == false)
                                  ...
                                  : (employer?.approved == false)
                                      ? "You will be notified once approved"
                                      : "Welcome, your are now approved"
                          : 'जारी रखने के लिए अपनी प्रोफ़ाइल पूर्ण करें',
                      textAlign: TextAlign.center,
                      style: const TextStyle(
                        color: Colors.black,
                        decorationThickness: 0,
                    ...
                    onTap: () {
                      ...
                      if ((employer == null ||
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => EmpPersonalInfoPage(
                              employer: employer,
                            ),
                          ),
                        );
  ...
  Future<dynamic> expire_dialog(BuildContext context) {
    return showDialog(
      context: context,
      builder: (BuildContext context) {
        return Center(
...
class _MyDialogState extends State<MyDialog> {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Text(
                _isEnglishSelected ? 'Filter By' : 'फिल्टर करें',
                style: const TextStyle(
            ...
            DropdownButtonFormField<String>(
              ...
              items: [
                DropdownMenuItem(
                  ...
                  child: Text(
                      _isEnglishSelected ? 'Andhra Pradesh' : 'आन्ध्र प्रदेश'),
                ),
                DropdownMenuItem(
                ...
                DropdownMenuItem(
                  value: 'Chhattisgarh',
                  child:
                      Text(_isEnglishSelected ? 'Chhattisgarh' : 'छत्तीसगढ़'),
                ),
                DropdownMenuItem(
                  value: 'Goa',
                ...
                DropdownMenuItem(
                  ...
                  child: Text(
                      _isEnglishSelected ? 'Madhya Pradesh' : 'मध्य प्रदेश'),
                ),
                DropdownMenuItem(
                  value: 'Maharashtra',
                  child:
                      Text(_isEnglishSelected ? 'Maharashtra' : 'महाराष्ट्र'),
                ),
                DropdownMenuItem(
                  value: 'Manipur',
                ...
                DropdownMenuItem(
                  value: 'Uttar Pradesh',
                  child: Text(
                      _isEnglishSelected ? 'Uttar Pradesh' : 'उत्तर प्रदेश'),
                ),
                DropdownMenuItem(
                  value: 'Uttarakhand',
                ...
                DropdownMenuItem(
                  value: 'West Bengal',
                  child:
                      Text(_isEnglishSelected ? 'West Bengal' : 'पश्चिम बंगाल'),
                ),
                DropdownMenuItem(
            ...
            DropdownButtonFormField<String>(
              decoration: InputDecoration(
                labelText:
                    _isEnglishSelected ? "Job Profile" : "नौकरी प्रोफ़ाइल",
                border: const UnderlineInputBorder(),
                labelStyle: const TextStyle(
                  color: Color(0xFF0098DA),
                ),
              ...
              items: [
                DropdownMenuItem(
                  value: 'Security Guard',
                  child: Text(
                      _isEnglishSelected ? 'Security Guard' : 'सुरक्षा कर्मी'),
                ),
                DropdownMenuItem(
                  value: 'Helper',
                  child: Text(_isEnglishSelected ? 'Helper' : 'सहायक'),
                ...
                DropdownMenuItem(
                  value: 'Delivery Boy',
                  child:
                      Text(_isEnglishSelected ? 'Delivery Boy' : 'वितरण लड़का'),
                ),
                DropdownMenuItem(
                  value: 'Driver',
                  child: Text(_isEnglishSelected ? 'Driver' : 'चालक'),
                ...
                DropdownMenuItem(
                  value: 'Cleaning Expert',
                  child: Text(
                      _isEnglishSelected ? 'Cleaning Expert' : 'सफाईसहायक'),
                ),
                DropdownMenuItem(
                  value: 'Accountant',
                  child: Text(_isEnglishSelected ? 'Accountant' : 'मुनीम'),
                ...
                DropdownMenuItem(
                  value: 'Service Staff',
                  child: Text(
                      _isEnglishSelected ? 'Service Staff' : 'सेवा कर्मचारी'),
                ),
                DropdownMenuItem(
                  value: 'Carpenter',
                  child: Text(_isEnglishSelected ? 'Carpenter' : 'बढ़ई'),
                ...
                DropdownMenuItem(
                  value: 'Photographer',
                  child:
                      Text(_isEnglishSelected ? 'Photographer' : 'फोटोग्राफर'),
                ),
                DropdownMenuItem(
                  value: 'Plumber',
                  child: Text(_isEnglishSelected ? 'Plumber' : 'पलंबर'),
                ...
                DropdownMenuItem(
                  value: 'Electrician',
                  child: Text(
                      _isEnglishSelected ? 'Electrician' : 'बिजली मिस्त्री'),
                ),
                DropdownMenuItem(
                  value: 'Washing Machine mechanic',
                  child: Text(_isEnglishSelected
                ...
                DropdownMenuItem(
                  value: 'Vehicle Mechanic',
                  child: Text(
                      _isEnglishSelected ? 'Vehicle Mechanic' : 'कार मिस्त्री'),
                ),
                DropdownMenuItem(
                  value: 'Makeup Artist',
                  child: Text(
                      _isEnglishSelected ? 'Makeup Artist' : 'मेक-अप अर्टिस्ट'),
                ),
                DropdownMenuItem(
                  value: 'Hair Stylish',
                  child: Text(
                      _isEnglishSelected ? 'Hair Stylish' : 'हेयर स्टाइलिश'),
                ),
                DropdownMenuItem(
                  value: 'Beauty Salon Staff',
                  child: Text(_isEnglishSelected
                ...
                DropdownMenuItem(
                  value: 'Factory Staff',
                  child: Text(
                      _isEnglishSelected ? 'Factory Staff' : 'फैक्टरी सहायक'),
                ),
                DropdownMenuItem(
                  value: 'Gym/ Yoga Trainer',
                  child: Text(_isEnglishSelected
                ...
                DropdownMenuItem(
                  value: 'Hotel Staff',
                  child: Text(
                      _isEnglishSelected ? 'Hotel Staff' : 'होटल कर्मचारी'),
                ),
                DropdownMenuItem(
                  value: 'Restaurant Staff',
                  child: Text(_isEnglishSelected
                ...
                DropdownMenuItem(
                  value: 'Mehndi Artist',
                  child: Text(
                      _isEnglishSelected ? 'Mehndi Artist' : 'मेहँदी अर्टिस्ट'),
                ),
                DropdownMenuItem(
                  value: 'Others',
                  child: Text(_isEnglishSelected ? 'Others' : 'अन्य'),
            ...
            Column(
              children: [
                Container(
                  ...
                  alignment: Alignment.centerLeft,
                  child: Text(
                    _isEnglishSelected ? 'Expected Salary' : 'अनुमानित वेतन',
                    style: const TextStyle(
                      color: Color(0xFF0098DA),
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                  ...
                  children: [
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          labelText: _isEnglishSelected ? 'Starting' : 'शुरुआत',
                          border: const UnderlineInputBorder(),
                          labelStyle: const TextStyle(
                            color: Color(0xFF0098DA),
                          ),
                    ...
                    Expanded(
                      child: TextField(
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(
                          labelText: _isEnglishSelected ? 'Till' : 'तक',
                          border: const UnderlineInputBorder(),
                          labelStyle: const TextStyle(
                            color: Color(0xFF0098DA),
                          ),
  ...
  List<DropdownMenuItem<String>> _getOptionsForOption2() {
