...
import 'package:rotijugaad/user_lang_update.dart';
import 'package:rotijugaad/payment_history.dart';
import 'package:rotijugaad/support.dart';
import 'package:rotijugaad/screens/UserApplication/user_applications.dart';
import 'package:rotijugaad/user_interest.dart';
import 'package:rotijugaad/user_notif.dart';
import 'package:rotijugaad/screens/Personal%20Info/user_profile_page.dart';
import 'package:rotijugaad/screens/Subscription/user_subscription.dart';
...
class _UserHomePageState extends State<UserHomePage> {
  ...
  getJobs() async {
    ...
    listOfJobs = await EmployeeService.getJobs();
    employee = await EmployeeService.getProfile();
    if (employee != null) {
      SharedPreferences pref = await SharedPreferences.getInstance();
      pref.setInt("EmployeeID", employee!.employeeID!);
      pref.setString("Name", employee!.name!);
      log("EmployeeID : ${pref.getInt("EmployeeID")}");
      log("Name : ${pref.getString("Name")}");
    }
    employeeModel = employee;
    setState(() {
      isLoading = false;
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border:
                              Border.all(color: Color(0xFF0098DA), width: 2),
                        ),
                        child: CircleAvatar(
                          backgroundImage:
                              AssetImage('assets/category/others.png'),
                        ),
                      ),
                      SizedBox(height: 10),
                      GestureDetector(
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => User_application(),
                            ),
                          );
                        },
                      ),
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    UserUpdateLanguageSelectScreen()),
                          );
                        },
                      ),
                      SizedBox(height: 10),
          ...
          child: Column(
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Material(
                        color: const Color.fromARGB(0, 218, 186, 186),
                        child: IconButton(
              ...
              isLoading
                  ...
                  : (listOfJobs == null || listOfJobs!.isEmpty)
                      ? Center(
                      ...
                      : Column(
                          children: listOfJobs!
                              .map((job) => JobTile(
                                    ...
                                    salary:
                                        '${job.salaryOffered} Per ${job.frequency}',
                                    sector: 'IT',
                                    vacancy: "${job.vacancy}",
                                    jobId: job.jobID!,
                    ...
                    onTap: () {
                      ...
                      if (employee == null ||
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UserPersonalInfoPage(
                              employee: employee,
                            ),
                          ),
                        );
...
class _JobTileState extends State<JobTile> {
  ...
  getData() async {
    try {
      log("Get Data Job Tile");
      SharedPreferences pref = await SharedPreferences.getInstance();
      String employeeId = pref.getInt("EmployeeID").toString() ?? "";

      isInterestSend =
          await EmployeeService.getEmployeeToEmployerJobIntresetByJobId(
  ...
  showJobDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return Center(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            isEnglishSelected
                                ? '${widget._vacancy} Vacancy Left'
                                : '${widget._vacancy} जगह ख़ाली',
                            style: const TextStyle(
                        ...
                        : Column(
                            children: [
                              isContact != null
                                  ...
                                  : GestureDetector(
                                      onTap: () async {
                                        if (widget.employee!.contactCredits! <
                                            1) {
                                          Utils.expire_dialog(
                                            context: context,
                                            onTap: () => log('Click'),
                                        ...
                                        log("Else Contact");
                                        String? response = await EmployeeService
                                            .postEmployeeToEmployerCall(
                                          context: context,
                              ...
                              GestureDetector(
                                  onTap: () async {
                                    if (widget.employee!.interestCredits! < 1) {
                                      Utils.expire_dialog(
                                        context: context,
                                        onTap: () => log('Click'),
                                        button: "Buy Subscription",
                                        ...
                                        subTitle:
                                            "Buy Subscription to send interest",
                                      );
                                      return;
                                    }

                                    if (isInterestSend == null ||
                                        isInterestSend != true) {
                                      bool? response = await EmployeeService
                                          .postEmployeeToEmployerJobIntrest(
                                        context: context,
                                      ...
                                      if (response == true) {
                                        Utils.showSnackBar(
                                            context, "Interest Sent");
                                      } else {
                                        Utils.showSnackBar(
                                            context, "Failed To Send Interest");
                                      }
                                    }
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              value: dropdownValue,
              items: Utils.jobProfileDropdownList(_isEnglishSelected),
              onChanged: (String? newValue) {
                setState(() {
                  dropdownValue = newValue!;
                });
