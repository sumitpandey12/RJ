...
class OTPVerificationScreen_user extends StatefulWidget {
  final String phoneNumber;
  final String otp;
  final String name;
  const OTPVerificationScreen_user(
      {super.key,
  ...
  @override
  _OTPVerificationScreen_user createState() => _OTPVerificationScreen_user();
}

class _OTPVerificationScreen_user extends State<OTPVerificationScreen_user> {
                ...
                Container(
                  ...
                  child: GestureDetector(
                      onTap: () {
                        ...
                        EmployerService.registerUser(
                            context, widget.name, widget.phoneNumber, "User");
