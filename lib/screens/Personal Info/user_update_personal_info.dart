...
class UserPersonalInfoUpdate extends StatefulWidget {
  ...
  const UserPersonalInfoUpdate({super.key, this.employee});
  @override
  _UserPersonalInfoUpdateState createState() => _UserPersonalInfoUpdateState();
}
...
class _UserPersonalInfoUpdateState extends State<UserPersonalInfoUpdate> {
  ...
  void initState() {
    ...
    if (widget.employee != null) {
      _email.text = widget.employee!.emailID!;
      _qualification = widget.employee!.qualification!;
      _salary.text = widget.employee!.expectedSalary.toString();
                ...
                children: [
                  ...
                  GestureDetector(
                    child: Container(
                      ...
                      child: Text(
                        _isEnglishSelected ? 'Update' : 'अपडेट',
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 20,
                    ...
                    onTap: () async {
                      await EmployeeService.createProfile(
                          context: context,
                          isPartial: true,
                          Age: widget.employee!.age.toString(),
                          Gender: widget.employee!.gender,
                          City: widget.employee!.city,
                          State_Ut: widget.employee!.stateUt,
                          Referred_By: widget.employee!.referredBy,
                          Qualification: _qualification,
                          Expected_Salary: _salary.text,
