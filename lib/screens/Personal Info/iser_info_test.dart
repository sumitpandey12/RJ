...
import 'package:rotijugaad/screens/Personal%20Info/user_add_xp.dart';
...
class UserPersonalInfoPage extends StatefulWidget {
  ...
  const UserPersonalInfoPage({super.key, this.employee});
  @override
...
class _UserPersonalInfoPageState extends State<UserPersonalInfoPage> {
  ...
  late TextEditingController _refferedByController;
  ...
  void initState() {
    ...
    _refferedByController = TextEditingController();
    _emailController = TextEditingController();
    if (widget.employee != null) {
      _ageController.text = widget.employee!.age.toString();
      _refferedByController.text = widget.employee!.referredBy!;
      _emailController.text = widget.employee!.emailID!;
      _prefstate = widget.employee!.preferredStateUt!;
      _prefcity = widget.employee!.preferredCity!;
      _prefshift = widget.employee!.preferredShift!;
      _qualification = widget.employee!.qualification!;
      _salary = widget.employee!.expectedSalary.toString();
      _salfreq = widget.employee!.salaryFrequency!;
      _selectedOption1 = widget.employee!.stateUt!;
      _selectedOption2 = widget.employee!.city!;
    }
  }
            ...
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  //     ),
                  //   ),
                  //   controller: _refferedByController,
                  //   validator: (value) {
                  //     if (value!.isEmpty) {
                        ...
                        SizedBox(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: [
                              DropdownMenuItem(
                                  child:
                                      Text(isEnglishSelected ? 'Month' : 'Day'),
                                  value: 'Month'),
                              DropdownMenuItem(
                                  child:
                                      Text(isEnglishSelected ? 'Day' : 'रोज'),
                                  value: 'Day'),
                            ],
                            onChanged: (value) {
                              setState(() {
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            if (_isMaleSelected == true) {
                              gender = "Male";
                            } else if (_isFemaleSelected == true) {
                              gender = "Female";
                            } else if (_isOtherSelected == true) {
                              gender = "Other";
                            } else {
                            ...
                            if (_ageController.text == "") {
                              Utils.showSnackBar(context, "Enter Age");
                              return;
                            }
                            ...
                            if (_selectedOption1 == null ||
                              ...
                              Utils.showSnackBar(
                                  context, "Select State and City");
                              return;
                            }
                            if (_referredby == "") {
                              Utils.showSnackBar(context, "Select Referred By");
                              return;
                            }
                            if (_qualification == null) {
                              Utils.showSnackBar(
                                  context, "Select Qualification");
                              return;
                            }
                            if (_salary == null) {
                              Utils.showSnackBar(context, "Enter Salary");
                              return;
                            }
                            if (_salfreq == null) {
                              Utils.showSnackBar(
                                  context, "Select Salary Frequency");
                              return;
                            }
                            if (_prefshift == null) {
                              Utils.showSnackBar(
                                  context, "Select Prefered Shift");
                              return;
                            }
                            if (_prefstate == null) {
                              Utils.showSnackBar(
                                  context, "Select Preferred State");
                              return;
                            }
                            if (_prefcity == null) {
                              Utils.showSnackBar(
                                  context, "Select Preferred City");
                              return;
                            }
                            EmployeeService.createProfile(
                                    context: context,
                                    isPartial: widget.employee != null,
                                    Age: _ageController.text,
                                    Gender: gender,
                                    City: _selectedOption2!,
                                    State_Ut: _selectedOption1!,
                                    Referred_By: _refferedByController.text,
                                    Qualification: _qualification!,
                                    Expected_Salary: _salary!,
                                    Salary_Frequency: _salfreq!,
                                    Preferred_Shift: _prefshift!,
                                    Preferred_State_Ut: _prefstate!,
                                    Preferred_City: _prefcity!,
                                    email: _emailController.text.trim(),
                                    ID: widget.employee?.employeeID.toString())
                                .then((value) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
