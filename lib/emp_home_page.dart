...
import 'package:rotijugaad/dev_info.dart';
import 'package:rotijugaad/emp_job.dart';
import 'package:rotijugaad/emp_lang_update.dart';
import 'package:rotijugaad/emp_personal_info.dart';
import 'package:rotijugaad/emp_profile_page.dart';
import 'package:rotijugaad/emp_subscription.dart';
import 'package:rotijugaad/hiring_history.dart';
...
import 'package:rotijugaad/view_user_profile.dart';
import 'globals.dart';
...
class _EmployerHomePageState extends State<EmployerHomePage> {
  ...
  fetchData() async {
    String jsonString = '''
      [  {    "User ID": 12345,    "User_Name": "Ram Kumar",    "profile_status": "Active",    "Age": 28,    "City": "Mumbai",    "State": "Maharashtra",    "Preferred_City": "Pune",    "Preferred_State": "Maharashtra",    "Qualification": "12th Pass",    "Expected Salary": 20000,    "Salary Frequency": "Monthly",    "profile_picture_link": "https://randomuser.me/api/portraits/men/55.jpg",    "contact number": "+91 1234567890",    "Job_preferences": [
      {
        "Preference_number": 1,
        "Job_title": "Cook/Chef",
        "Job_image_link": "assets/category/cook.png"
      },
      {
        "Preference_number": 2,
        "Job_title": "Carpenter",
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    ViewUserProfile(userData: data[index]),
                              ),
                            );
                          },
                          child: Padding(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image.network(
                                                '${data[index]["profile_picture_link"]}',
                                                fit: BoxFit.cover,
                                              ),
                                            ),
                                          ),
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  left: 8.0),
                                              child: Text(
                                                "${data[index]["Job_preferences"][0]["Job_title"]}",
                                                style: TextStyle(
                                                    color: Color(0xFF0098DA),
                                                    fontSize: 22,
                                                    fontWeight:
                                            ...
                                            Padding(
                                              ...
                                              child: Container(
                                                ...
                                                padding: EdgeInsets.symmetric(
                                                    ...
                                                    vertical: 5),
                                                child: Text(
                                                  '${data[index]["Expected Salary"]} ${data[index]["Salary Frequency"]}',
                                                  style: TextStyle(
                                                      color: Colors.white,
                                                      fontSize: 16),
                                                ),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Text(
                                                    '${data[index]["Preferred_City"]}, ${data[index]["Preferred_State"]}',
                                                    overflow:
